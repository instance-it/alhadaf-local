            ...
            createLi: function() {
                ...
                o.each(function(C) {
                    ...
                    if (B.data('thumbnail')) {
                        ...
                        F =
                          '<span class="media">' +
                            '<span class="media-left"><img src="' + B.data('thumbnail') + '" class="media-object" onerror="src=\'data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7\'"></span>' +
                            '<span class="media-body">' + F + '</span>' +
                          '</span>';
                      } else if (!B.data('content')) {
                        // Prepend any icon and append any subtext to the main text
                        F =  '<span class="text">' + F + R + '</span>';
                      }
