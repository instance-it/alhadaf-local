$(document).ready(function() {
    ...
    // Get the modal
    var modal = document.getElementById("addLeaveDetailModal");

    // Get the button that opens the modal
    // var btn = document.getElementById("btnMAC");
    ...
    var calendar = $('#calendar').fullCalendar({
        ...
        events: [
            {
                ...
                end: newDate.getFullYear() + '-'+ getDynamicMonth('default') +'-01T16:30:00',
                className: "bg-danger",
            ...
            },
            {
                ...
                end: newDate.getFullYear() + '-'+ getDynamicMonth('default') +'-07T20:30:00',
            ...
            },
            {
                ...
                end: newDate.getFullYear() + '-'+ getDynamicMonth('default') +'-17T17:30:00',
            ...
            },
            {
                ...
                end: newDate.getFullYear() + '-'+ getDynamicMonth('default') +'-12T12:30:00',
                className: "bg-danger",
            ...
            },
            {
                ...
                end: newDate.getFullYear() + '-'+ getDynamicMonth('default') +'-12T17:00:00',
                className: "bg-warning",
            ...
            },
            {
                ...
                end: newDate.getFullYear() + '-'+ getDynamicMonth('default') +'-12T23:30:00',
            ...
            },
            {
                ...
                end: newDate.getFullYear() + '-'+ getDynamicMonth('default') +'-12T01:30:00',
                className: "bg-warning",
            ...
            },
            {
                ...
                end: newDate.getFullYear() + '-'+ getDynamicMonth('default') +'-12T23:00:00',
                className: "bg-danger",
            ...
            },
            {
                ...
                end: newDate.getFullYear() + '-'+ getDynamicMonth('default') +'-27T24:00:00',
                className: "bg-success",
                description: 'Sed purus urna, aliquam et pharetra ut, efficitur id mi. Pellentesque ut convallis velit. Lorem ipsum dolor sit amet, consectetur adipiscing elit.'
            },
            {
                ...
                end: newDate.getFullYear() + '-'+ getDynamicMonth('default') +'-24T8:32:20',
                className: "bg-danger",
                description: 'Sed purus urna, aliquam et pharetra ut, efficitur id mi. Pellentesque ut convallis velit. Lorem ipsum dolor sit amet, consectetur adipiscing elit.'
            },
            {
                ...
                end: newDate.getFullYear() + '-' + getDynamicMonth('dec') +'-13T9:20:20',
                className: "bg-primary",
            ...
            },
            {
                ...
                end: newDate.getFullYear() + '-'+ getDynamicMonth('inc') +'-15T22:20:20',
                className: "bg-primary",
                description: 'Pellentesque ut convallis velit. Sed purus urna, aliquam et pharetra ut, efficitur id mi. Lorem ipsum dolor sit amet, consectetur adipiscing elit.'
            }
        ...
        eventClick: function(info) {
            ...
            modal.style.display = "block";
            //modal.style.display = "none";
            // $('#rightSidebar').addClass('active-right-sidebar');
            ...
            var taskDescriptionValue = taskDescription.text(eventDescription);
