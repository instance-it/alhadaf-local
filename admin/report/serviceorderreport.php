                        ...
                        <div class="row min-height-100">
                            <div class="col-12 min-height-100">
                                <div class="table-responsive main-grid">
                                    ...
                                    $qryord="select distinct o.timestamp as primary_date,o.id,o.transactionid,o.orderno,pm.personname,pm.contact,
                                        convert(varchar, o.timestamp,100) AS ofulldate,o.totalpaid,o.iscancel,pm1.personname as entrypersonname,pm1.contact as entrypersoncontact,s.storename
                                        from tblserviceorder o 
                                        inner join tblserviceorderdetail sod on sod.orderid=o.id
                                        ...
                                        where convert(varchar(50),o.storeid) like :storeid and convert(varchar(50),o.uid) like :memberid and convert(varchar(50),sod.itemid) like :itemid ";
                                    $ordparms = array(
                                        ':storeid'=>$storeid,
                                        ':memberid'=>$memberid,
                                        ':itemid'=>$itemid,
                                        ...
                                        <table id="tableDataList" data-show="1" data-nextpage='0' class="table table-bordered11 table-hover datalisttable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="tbl-name text-center" style="width: 10%;">Order Date</th>
                                                    <th class="tbl-name text-left" style="width: 15%;">Entry By</th>
                                                    <th class="tbl-name text-left" style="width: 8%;">Status</th>
                                                </tr>
                                            </thead>
                                            <tbody id="datalist">
                                                <?php
                                                    for($i=0;$i<sizeof($resord);$i++)
                                                    {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="tbl-name text-center">
                                                                <?php 
                                                                if($roword['iscancel'] == 1)
                                                                {
                                                                    echo '<span class="btn btn-danger px-2 py-0">Cancelled</span>';
                                                                }
                                                                else
                                                                {
                                                                    echo '-';
                                                        ...
                                                        if($withorderdetail == 1)  //Order Item Detail
                                                        {
                                                            ...
                                                            $qryod="select sod.id,sod.orderid,sod.type,sod.typename,sod.catid,sod.category,sod.subcatid,sod.subcategory,sod.itemid,sod.itemname,sod.qty,sod.issued_qty AS issuedqty,sod.remain_qty as remainqty,
                                                                sod.taxtype,sod.taxtypename,sod.sgst,sod.cgst,sod.igst,sod.price,sod.discountper,sod.discountamt,sod.taxable,sod.sgsttaxamt,sod.cgsttaxamt,
                                                                sod.igsttaxamt,sod.finalprice,sod.iscancel
                                                                from tblserviceorderdetail sod 
                                                                where sod.orderid=:orderid and convert(varchar(50),sod.itemid) like :itemid ";
                                                            $odparams = array(
                                                                ':orderid'=>$roword['id'],
                                                                ':itemid'=>$itemid,
                                                            );
                                                                    ...
                                                                    <table id="tableDataList" data-show="1" data-nextpage='0' class="table table-bordered11 table-hover datalisttable">
                                                                        <thead>
                                                                            <tr>
                                                                                ...
                                                                                <th class="tbl-name text-right" style="width: 10%;">Amount</th>
                                                                                <th class="tbl-name text-right" style="width: 10%;">Item Status</th>
                                                                            </tr>
                                                                        </thead>
                                                                        <tbody id="datalist">
                                                                            <?php
