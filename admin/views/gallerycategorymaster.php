...
?>
			...
			<div class="col-12 layout-spacing d-none">
				<div class="widget">
					<div class="widget-heading m-0">
						<div class="row">
							<div class="col">
								<h5 class="my-2">Gallery Category Master</h5>
							</div>
										...
										<table id="tableDataList" data-show="1" data-nextpage='0' class="table table-bordered table-hover table-striped datalisttable">
											<thead>
												<tr>
													...
													<th class="tbl-name sorting sorting_asc" data-th="gcm.category">Category</th>
													<th class="tbl-name sorting" data-th="gcm.displayorder">Display Order</th>
												</tr>
											</thead>
											<tbody id="datalist">
											</tbody>
					...
					<div class="right-sidebar-content">
						<div class="row">   
							...
							<div class="col-lg-12 col-md-12 col-12">
								<div class="widget">
									<div class="widget-content">
										<form class="row validate-form" id="gallerycategorymasterForm" method="post" action="gallerycategorymaster" enctype="multipart/form-data">
											...
											<div class="col-12">
												...
												<div class="input-group mb-3">
													<input type="text" class="form-control" placeholder="Category Name" id="categoryname" name="categoryname" require>
												</div>
											</div>
	...
	<script>
		...
		function resetdata()
        {
            $("#gallerycategorymasterForm").validate().resetForm();
            $('#gallerycategorymasterForm').trigger("reset");
        ...
        function editdata(id)
        {
            ...
            formdata.append("action", "editgallerycategorymaster");
        ...
        function OnsuccessSubbrandedit(content)
        {
            ...
            $('#categoryname').val(resultdata.category);
		...
		if($('#gallerycategorymasterForm').length){		
            $('#gallerycategorymasterForm').validate({
                rules:{
                    categoryname:{
                        required: true,			
                    },
                ...
                submitHandler: function(form){
                    ...
                    formdata.append("action", "insertgallerycategory");
