...
?>
                                    ...
                                    <table id="tableDataList" data-show="1" data-nextpage='0' class="table table-bordered table-hover table-striped datalisttable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="tbl-name sorting_asc sorting" data-th="iconname">Icon Name</th>
                ...
                <div class="right-sidebar-content">
                    <div class="row">   
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            <div class="widget">
                                <div class="widget-content">
                                    <form class="text-left validate-form" id="iconmasterForm" method="post" action="iconmaster.php" enctype="multipart/form-data">
                                        <input type="hidden" id="formevent" name="formevent" value='addright'>
                                        <input type="hidden" id="id" name="id" value=''>
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="input-group mb-0">
                                                    <label class="mb-1">Icon Name <span class="text-danger">*</span></label>
                                                </div>
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control" placeholder="Icon Name" id="iconname" name="iconname">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="input-group mb-0">
                                                    <label class="mb-1">Icon Style <span class="text-danger">*</span></label>
                                                </div>
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control" placeholder="Icon Style" id="iconstyle" name="iconstyle">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="input-group mb-0">
                                                    <label class="mb-1">Icon Class <span class="text-danger">*</span></label>
                                                </div>
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control" placeholder="Icon Class" id="iconclass" name="iconclass">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="input-group mb-0">
                                                    <label class="mb-1">Icon Unicode <span class="text-danger">*</span></label>
                                                </div>
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control" placeholder="Icon Unicode" id="iconunicode" name="iconunicode">
                                                </div>
                                            </div>
                                            <div class="col-auto ml-auto">
                                                <div class="input-group mb-0">
    ...
    <script>
        ...
        function resetdata()
        {
            $("#iconmasterForm").validate().resetForm();
            $('#iconmasterForm').trigger("reset");
        ...
        function editdata(id)
        {
            ...
            formdata.append("action", "editiconmaster");
            formdata.append("id", id);

            ajaxrequest("POST",'<?php echo $config->getEndpointurl(); ?>'+pagename,formdata,headersdata,OnsuccessIconedit,OnErrorIconedit); 
        }

        function OnsuccessIconedit(content)
        {
            var JsonData = JSON.stringify(content);
            var resultdata = jQuery.parseJSON(JsonData);

            $('#id').val(resultdata.id);
            $('#iconname').val(resultdata.iconname);
            $('#iconstyle').val(resultdata.iconstyle);  
            $('#iconclass').val(resultdata.iconclass);  
            $('#iconunicode').val(resultdata.iconunicode);  
        ...
        function OnErrorIconedit(content)
        { 
            ajaxrequest("POST","'<?php echo $config->getPage404url(); ?>'",'','',OnsuccessRender,OnErrorRender);
        }
        //Edit End

        if($('#iconmasterForm').length){		
            $('#iconmasterForm').validate({
                rules:{
                    iconname:{
                        required: true,			
                    },
                    ...
                    iconstyle:{
                        required:"Icon style is required",
                    },
                    iconclass:{
                        required:"Icon class is required",
                    },
                    iconunicode:{
                        required:"Icon unicode is required",
                    },
                },
                submitHandler: function(form){
                    ...
                    formdata.append("action", "inserticonmaster");
