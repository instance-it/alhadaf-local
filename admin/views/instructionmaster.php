...
?>
										...
										<table id="tableDataList" data-show="1" data-nextpage='0' class="table table-bordered table-hover table-striped datalisttable">
											<thead>
												<tr>
													...
													<th class="tbl-name sorting sorting_asc" data-th="name">Instruction</th>
					...
					<div class="right-sidebar-content">
						<div class="row">   
							...
							<div class="col-lg-12 col-md-12 col-12">
								<div class="widget">
									<div class="widget-content">
										<form class="row validate-form" id="instructionmasterForm" method="post" action="instructionmaster" enctype="multipart/form-data">
											...
											<div class="col-12">
												...
												<div class="input-group mb-3">
													<textarea type="text" class="form-control" placeholder="Instruction" id="name" name="name" rows="8" maxlength="500" require></textarea>
												</div>
											</div>
	...
	<script>
		...
		function resetdata()
        {
            $("#instructionmasterForm").validate().resetForm();
        ...
        function editdata(id)
        {
            ...
            formdata.append("action", "editinstructionmaster");
		...
		if($('#instructionmasterForm').length){		
            $('#instructionmasterForm').validate({
                rules:{
                    name:{
                        required: true,			
                    },
                ...
                submitHandler: function(form){
                    ...
                    formdata.append("action", "insertinstruction");
		...
		//Change Is Active Start
        function changeisactiveinstruction(id)
        {
            var pagename=getpagename();
            var headersdata= {Accept: 'application/json',platform: 1,userpagename:pagename,useraction:'editright',masterlisting:false};
            formdata = new FormData();
            formdata.append("action", "changeisactiveinstruction");
            formdata.append("id", id);
            ajaxrequest("POST",'<?php echo $config->getEndpointurl(); ?>'+pagename,formdata,headersdata,Onsuccesschangeisactiveinstruction,OnErrorchangeisactiveinstruction); 
        }

        function Onsuccesschangeisactiveinstruction(data)
        {
        ...
        function OnErrorchangeisactiveinstruction(content)
        { 
            ajaxrequest("POST","'<?php echo $config->getPage404url(); ?>'",'','',OnsuccessRender,OnErrorRender);
        }
