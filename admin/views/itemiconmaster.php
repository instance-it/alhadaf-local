...
?>
	<div class="layout-px-spacing">
										...
										<table id="tableDataList" data-show="1" data-nextpage='0' class="table table-bordered table-hover table-striped datalisttable">
											<thead>
												<tr>
													...
													<th class="tbl-name sorting sorting_asc" data-th="iconname">Icon Name</th>
					...
					<div class="right-sidebar-content">
						<div class="row">   
							...
							<div class="col-lg-12 col-md-12 col-12">
								<div class="widget">
									<div class="widget-content">
										<form class="row validate-form" id="itemiconmasterForm" method="post" action="itemiconmaster" enctype="multipart/form-data">
											...
											<div class="col-12 col-sm-12 col-md-12 col-lg-12">
												...
												<div class="input-group mb-3">
													<input type="text" class="form-control" placeholder="Icon Name" id="iconname" name="iconname" require>
												</div>
											</div>
											...
											<div class="col-12 col-sm-12 col-md-12 col-lg-12">
												...
												<div class="input-group mb-3 mb-lg-3">
													...
													<span style="color:#B00" class="imgsizelbl2">** Please upload icon in JPG,JPEG,PNG Format</span>
												</div>
											</div>
		...
		<!-- Images View Modal -->
		<div class="modal animated fade" id="IconImgModal" tabindex="-1" role="dialog" aria-labelledby="modalImgViewLabel" aria-hidden="true">
					...
					<div class="modal-body">
						<div class="row mb-4">
							<div class="col-12">
								...
								<h5 class="add-event-title modal-title">Icon</h5>
							</div>
						</div>
						<div class="row">
							<div class="col-lg-12 col-md-12 col-12 text-center">                                                
								<a href="" class="clscatimglink" target="_blank"><img src="" alt="icon" class="img-thumbnail clscatimg"/></a>
							</div>
						</div>
					</div>
				</div>
	...
	<script>
		...
		function resetdata()
        {
            $("#itemiconmasterForm").validate().resetForm();
            $('#itemiconmasterForm').trigger("reset");
        ...
        function Onsuccessiconedit(content)
        {
            ...
            $('#iconname').val(resulteditdata.iconname);
		...
		//View Icon Image
		function viewiconimage(imgfullurl,iconname)
        {
			$('#IconImgModal .modal-title').html(iconname);
			$('#IconImgModal .clscatimg').attr('src',imgfullurl);
			$('#IconImgModal .clscatimglink').attr('href',imgfullurl);
            $('#IconImgModal').modal('show');
        }


		//Validate
		if($('#itemiconmasterForm').length){		
            $('#itemiconmasterForm').validate({
                rules:{
					iconname:{
                        required: true,			
                    },
                ...
                submitHandler: function(form){
					...
					formdata.append("action", "inserticon");
