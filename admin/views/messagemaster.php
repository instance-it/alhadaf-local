...
?>
										...
										<table id="tableDataList" data-show="1" data-nextpage='0' class="table table-bordered table-hover table-striped datalisttable">
											<thead>
												<tr>
													...
													<th class="tbl-name sorting sorting_asc" data-th="mm.messagenameid">Message Name ID</th>
													<th class="tbl-name sorting" data-th="mm.messageengname">Message English Name</th>
													<th class="tbl-name sorting" data-th="mm.variables">Variables</th>
												</tr>
											</thead>
											<tbody id="datalist">
											</tbody>
					...
					<div class="right-sidebar-content">
						<div class="row">   
							...
							<div class="col-lg-12 col-md-12 col-12">
								<div class="widget">
									<div class="widget-content">
										<form class="row validate-form" id="messagemasterForm" method="post" action="messagemaster" enctype="multipart/form-data">
											<input type="hidden" id="formevent" name="formevent" value='addright'>
											<input type="hidden" id="id" name="id" value=''>

											<div class="col-12">
												<div class="input-group">
													<label class="mb-1">Message Name ID <span class="text-danger">*</span></label>
													<label class="ml-auto "></label>
												</div>
												<div class="input-group mb-3">
													<input type="text" class="form-control" placeholder="Message Name ID" id="messagenameid" name="messagenameid" require>
												</div>
											</div>

											<div class="col-12">
												<div class="input-group">
													<label class="mb-1">Message English Name <span class="text-danger">*</span></label>
													<label class="ml-auto "></label>
												</div>
												<div class="input-group mb-3">
													<input type="text" class="form-control" placeholder="Message English Name" id="messageengname" name="messageengname" require>
												</div>
											</div>

											<div class="col-12">
												<div class="input-group">
													<label class="mb-1">Variables (Comma Seprated) </label>
													<label class="ml-auto "></label>
												</div>
												<div class="input-group mb-3">
													<input type="text" class="form-control" placeholder="Variables (Comma Seprated)" id="variables" name="variables" require>
												</div>
											</div>
	...
	<script>
		...
		function resetdata()
        {
            $("#messagemasterForm").validate().resetForm();
            $('#messagemasterForm').trigger("reset");
        ...
        function editdata(id)
        {
            ...
            formdata.append("action", "editmessagemaster");
        ...
        function OnsuccessSubcategoryedit(content)
        {
            ...
            $('#messagenameid').val(resulteditdata.messagenameid);
			$('#messageengname').val(resulteditdata.messageengname);  
			$('#variables').val(resulteditdata.variables);  
		...
		if($('#messagemasterForm').length){		
            $('#messagemasterForm').validate({
                rules:{
                    messagenameid:{
                        required: true,			
                    },
                    ...
                    messagenameid:{
                        required:"Message name id is required",
                    },
					messageengname:{
                        required: "Message english name is required",		
                    },
                },
                submitHandler: function(form){
                    ...
                    formdata.append("action", "insertmessagemaster");
