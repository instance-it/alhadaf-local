                ...
                <div class="col-12 col-md-12 col-xl-12 mb-3">
                    <div class="widget">
                        <div class="widget-content">
                            <form class="text-left validate-form" id="mshipsalesummaryreportForm" method="post" target="_blank" action="<?php echo $config->getReporturl(); ?>mshipsalesummaryreport" enctype="multipart/form-data">
                                <div class="row">
...
<!-- CONTENT AREA -->
    ...
    <script>
        ...
        function resetdata()
        {
            $("#mshipsalesummaryreportForm").validate().resetForm();
            $('#mshipsalesummaryreportForm').trigger("reset");
            $('.selectpicker').selectpicker('refresh');
            fillstore();
            fillsaleperson();
        ...
        function fillitem()
        {
            ...
            formdata.append("isnotmshippkgcourse", '0');
			formdata.append("isall", 1);
