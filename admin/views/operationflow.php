    ...
    function addNodeToDrawFlow(name,operationname, pos_x, pos_y) {
      ...
      /*  ev.preventDefault();
       ...
       if(storeid)
       {
            ...
            telin += '                           <div class="row">';
            telin += '                                <div class="col">';
            telin += '                                    <p>Service Order :</p>';
            telin += '                                </div>';
            telin += '                                <div class="col-auto my-auto">';
            telin += '                                   <label class="switch switch-success m-0">';
            telin += '                                       <input type="checkbox" class="isserviceorder" id="isserviceorder'+name+''+count+'" data-count="'+count+'"  data-operationid="'+name+'" value="1" name="isserviceorder'+count+'" >';
            ...
            telin += '                          <div class="row">';
            telin += '                             <div class="col-12 my-auto">';
            telin += '                                 <select  id="rangeid'+name+''+count+'"  name="rangeid'+count+'[]" multiple="multiple" data-count="'+count+'"  data-operationid="'+name+'" class="form-control selectpicker rangeid">';
            telin += '                                 </select>';
            telin += '                             </div>';
            telin += '                          </div>';
            telin += '                     </div>';
    ...
    $(document).ready(function () {
        ...
        function OnsuccessOperationflow(content)
        {
            ...
            for(var i in resultdata.nodedata)
            {
                ...
                if(resultdata.nodedata[i].isserviceorder == 1)
                {
                    $("#isserviceorder"+operationid+countid).prop("checked", true);
                }
                else
                {
                    $("#isserviceorder"+operationid+countid).prop("checked", false);
                }
                ...
                function Onsuccessedtfillrange(content)
                {
                    ...
                    if(resultrdata.rangeid !== null || resultrdata.rangeid !== '')
                    {
                        ...
                        $('#rangeid'+resultrdata.operationid+''+resultrdata.countid).selectpicker('val', rr);
                    }
