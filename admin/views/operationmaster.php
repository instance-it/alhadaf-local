...
?>
										...
										<table id="tableDataList" data-show="1" data-nextpage='0' class="table table-bordered table-hover table-striped datalisttable">
											<thead>
												<tr>
													...
													<th class="tbl-name sorting sorting_asc" data-th="name">Operation</th>
												</tr>
											</thead>
											<tbody id="datalist">
											</tbody>
					...
					<div class="right-sidebar-content">
						<div class="row">   
							...
							<div class="col-lg-12 col-md-12 col-12">
								<div class="widget">
									<div class="widget-content">
										<form class="row validate-form" id="operationmasterForm" method="post" action="operationmaster" enctype="multipart/form-data">
											<input type="hidden" id="formevent" name="formevent" value='addright'>
											<input type="hidden" id="id" name="id" value=''>	
											<div class="col-12">
												<div class="input-group">
													<label class="mb-1">Operation Name <span class="text-danger">*</span></label>
													<label class="ml-auto "></label>
												</div>
												<div class="input-group mb-3">
													<input type="text" class="form-control" placeholder="Operation Name" id="operation" name="operation" require>
												</div>
											</div>
	...
	<script>
		...
		function resetdata()
        {
            $("#operationmasterForm").validate().resetForm();
            $('#operationmasterForm').trigger("reset");
        ...
        function editdata(id)
        {
            ...
            formdata.append("action", "editoperationmaster");
        ...
        function OnsuccessSubbrandedit(content)
        {
            ...
            $('#operation').val(resultdata.operation); 
		...
		if($('#operationmasterForm').length){		
            $('#operationmasterForm').validate({
                rules:{
                    operation:{
                        required: true,			
                    },
                ...
                submitHandler: function(form){
                    ...
                    formdata.append("action", "insertoperation");
