                ...
                <div class="col-12 col-md-12 col-xl-12 mb-3">
                    <div class="widget">
                        <div class="widget-content">
                            <form class="text-left validate-form" id="serviceorderreportForm" method="post" target="_blank" action="<?php echo $config->getReporturl(); ?>serviceorderreport" enctype="multipart/form-data">
                                <div class="row">
...
<!-- CONTENT AREA -->
    ...
    <script>
        ...
        function resetdata()
        {
            $("#serviceorderreportForm").validate().resetForm();
            $('#serviceorderreportForm').trigger("reset");
            $('.selectpicker').selectpicker('refresh');
            fillstore();
            fillmember();
