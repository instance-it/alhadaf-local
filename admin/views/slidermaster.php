...
?>
			...
			<div class="col-12 layout-spacing d-none">
				<div class="widget">
					<div class="widget-heading m-0">
						<div class="row">
							<div class="col">
								<h5 class="my-2">Slider Master</h5>
							</div>
										...
										<table id="tableDataList" data-show="1" data-nextpage='0' class="table table-bordered table-hover table-striped datalisttable">
											<thead>
												<tr>
													...
													<th class="tbl-name sorting " data-th="gm.title">Name</th>
					...
					<div class="right-sidebar-content">
						<div class="row">   
							...
							<div class="col-lg-12 col-md-12 col-12">
								<div class="widget">
									<div class="widget-content">
										<form class="row validate-form" id="slidermasterForm" method="post" action="slidermaster" enctype="multipart/form-data">
												...
												<!-- <div class="input-group mb-3 mb-lg-3">													
													<div class="filepreview">
														...
														<label class="filepreviewbg" for="img">
															<img class="d-none filepreviewimg" id="filepreviewimg" src="assets/img/logo-white.png">
														</label>
													</div>
													<span style="color:#B00" class="imgsizelbl2">** Please upload image in JPG,JPEG,PNG Format</span>
												</div> -->
	...
	<script>
		...
		function resetdata()
        {
            $("#slidermasterForm").validate().resetForm();
            $('#slidermasterForm').trigger("reset");
        ...
        function editdata(id)
        {
            ...
            formdata.append("action", "editslidermaster");
		...
		function viewSliderimage(imgfullurl)
        {
			$('#SliderImgModal .clscatimg').attr('src',imgfullurl);
			$('#SliderImgModal .clscatimglink').attr('href',imgfullurl);
            $('#SliderImgModal').modal('show');
        }
		...
		function changeSliderstatus(id)
        {
            ...
            var headersdata= {Accept: 'application/json',platform: 1,userpagename:pagename,useraction:'editright',masterlisting:false};
            formdata = new FormData();
            formdata.append("action", "changeSliderstatus");
            formdata.append("id", id);
            ajaxrequest("POST",'<?php echo $config->getEndpointurl(); ?>'+pagename,formdata,headersdata,OnsuccesschangeSliderstatus,OnErrorchangeSliderstatus); 
        }

        function OnsuccesschangeSliderstatus(data)
        {
        ...
        function OnErrorchangeSliderstatus(content)
        { 
            ajaxrequest("POST","'<?php echo $config->getPage404url(); ?>'",'','',OnsuccessRender,OnErrorRender);
        }

		if($('#slidermasterForm').length){		
            $('#slidermasterForm').validate({
                rules:{
                    title:{
                        required: true,			
                    },
                ...
                submitHandler: function(form){
                    ...
                    formdata.append("action", "insertslidermaster");
