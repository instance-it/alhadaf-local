...
?>
										...
										<table id="tableDataList" data-show="1" data-nextpage='0' class="table table-bordered table-hover table-striped datalisttable">
											<thead>
												<tr>
													...
													<th class="tbl-name sorting sorting_asc" data-th="state">State</th>
												</tr>
											</thead>
											<tbody id="datalist">
											</tbody>
					...
					<div class="right-sidebar-content">
						<div class="row">   
							...
							<div class="col-lg-12 col-md-12 col-12">
								<div class="widget">
									<div class="widget-content">
										<form class="row validate-form" id="statemasterForm" method="post" action="statemaster" enctype="multipart/form-data">
											<input type="hidden" id="formevent" name="formevent" value='addright'>
											<input type="hidden" id="id" name="id" value=''>	
											<div class="col-12">
												<div class="input-group">
													<label class="mb-1">State Name <span class="text-danger">*</span></label>
													<label class="ml-auto "></label>
												</div>
												<div class="input-group mb-3">
													<input type="text" class="form-control" placeholder="State Name" id="state" name="state" require>
												</div>
											</div>
	...
	<script>
		...
		function resetdata()
        {
            $("#statemasterForm").validate().resetForm();
            $('#statemasterForm').trigger("reset");
        ...
        function editdata(id)
        {
            ...
            formdata.append("action", "editstatemaster");
        ...
        function OnsuccessSubbrandedit(content)
        {
            ...
            $('#statetypeid').val(resultdata.statetypeid); 
			$('#statetypeid').selectpicker('refresh');   
		...
		if($('#statemasterForm').length){		
            $('#statemasterForm').validate({
                rules:{
                    state:{
                        required: true,			
                    },
                ...
                submitHandler: function(form){
                    ...
                    formdata.append("action", "insertstate");
