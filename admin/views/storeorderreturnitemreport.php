                ...
                <div class="col-12 col-md-12 col-xl-12 mb-3">
                    <div class="widget">
                        <div class="widget-content">
                            <form class="text-left validate-form" id="storeorderreturnitemreportForm" method="post" target="_blank" action="<?php echo $config->getReporturl(); ?>storeorderreturnitemreport" enctype="multipart/form-data">
                                <div class="row">
...
<!-- CONTENT AREA -->
    ...
    <script>
        ...
        function resetdata()
        {
            $("#storeorderreturnitemreportForm").validate().resetForm();
            $('#storeorderreturnitemreportForm').trigger("reset");
            $('.selectpicker').selectpicker('refresh');
            fillstore();
            fillmember();
        }
