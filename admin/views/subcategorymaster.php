...
?>
										...
										<table id="tableDataList" data-show="1" data-nextpage='0' class="table table-bordered table-hover table-striped datalisttable">
											<thead>
												<tr>
													...
													<th class="tbl-name sorting sorting_asc" data-th="cm.category">Category</th>
													<th class="tbl-name sorting" data-th="sc.subcategory">Sub Category Name</th>
													<th class="tbl-name sorting" data-th="sc.displayorder">Display Order</th>
					...
					<div class="right-sidebar-content">
						<div class="row">   
							...
							<div class="col-lg-12 col-md-12 col-12">
								<div class="widget">
									<div class="widget-content">
										<form class="row validate-form" id="subcategorymasterForm" method="post" action="subcategorymaster" enctype="multipart/form-data">
											...
											<div class="col-12">
												...
												<div class="input-group mb-3">
													<input type="text" class="form-control" placeholder="Sub Category Name" id="subcategoryname" name="subcategoryname" require>
												</div>
											</div>
	...
	<script>
		...
		function resetdata()
        {
            $("#subcategorymasterForm").validate().resetForm();
            $('#subcategorymasterForm').trigger("reset");
        ...
        function editdata(id)
        {
            ...
            formdata = new FormData();
            formdata.append("action", "editsubcategorymaster");
        ...
        function OnsuccessSubcategoryedit(content)
        {
            ...
            $('#subcategoryname').val(resulteditdata.subcategory);
		...
		if($('#subcategorymasterForm').length){		
            $('#subcategorymasterForm').validate({
                rules:{
					categoryid:{
						required: true,			
					},
