...
?>
	<div class="layout-px-spacing">
										...
										<table id="tableDataList" data-show="1" data-nextpage='0' class="table table-bordered table-hover table-striped datalisttable">
											<thead>
												<tr>
													...
													<th class="tbl-name sorting sorting_asc" data-th="videoid">Video</th>
													<th class="tbl-name sorting sorting_asc" data-th="displayorder">Display Order</th>
													<?php 
					...
					<div class="right-sidebar-content">
						<div class="row">   
							...
							<div class="col-lg-12 col-md-12 col-12">
								<div class="widget">
									<div class="widget-content">
										<form class="row validate-form" id="videomasterForm" method="post" action="videomaster" enctype="multipart/form-data">
											<input type="hidden" id="formevent" name="formevent" value='addright'>
											<input type="hidden" id="id" name="id" value=''>	
											<div class="col-12">
												<div class="input-group">
													<label class="mb-1">Video ID <span class="text-danger">*</span></label>
													<label class="ml-auto "></label>
												</div>
												<div class="input-group mb-3">
													<input type="text" class="form-control" placeholder="https://www.youtube.com/watch?v='..PASTE SHORT CODE HERE..'" id="videoid" name="videoid" require>
												</div>
											</div>
											<div class="col-12">
												<div class="input-group">
												...
												<div class="input-group mb-3">
													<input type="text" class="form-control" placeholder="Display Order" id="displayorder" name="displayorder" require>
												</div>
											</div>
		...
		<div class="modal fade" id="videoModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
					...
					<div class="modal-body">
						<div class="row mb-4">
							<div class="col-12">
								...
								<h5 class="modal-title" id="AddServicesLabel">Video</h5>
							</div>
							<div class="col-12">
	...
	<script>
		...
		function resetdata()
        {
            $("#videomasterForm").validate().resetForm();
            $('#videomasterForm').trigger("reset");
        ...
        function editdata(id)
        {
            ...
            formdata.append("action", "editvideomaster");
        ...
        function OnsuccessSubbrandedit(content)
        {
            ...
            $('#videoid').val(resultdata.videoid);
		...
		if($('#videomasterForm').length){		
            $('#videomasterForm').validate({
                rules:{
                    videoid:{
                        required: true,			
                    },
                ...
                submitHandler: function(form){
                    ...
                    formdata.append("action", "insertvideo");
		...
		function changevideostatus(id)
        {
            ...
            var headersdata= {Accept: 'application/json',platform: 1,userpagename:pagename,useraction:'editright',masterlisting:false};
            formdata = new FormData();
            formdata.append("action", "changevideostatus");
            formdata.append("id", id);
            ajaxrequest("POST",'<?php echo $config->getEndpointurl(); ?>'+pagename,formdata,headersdata,Onsuccesschangevideostatus,OnErrorchangevideostatus); 
        }

        function Onsuccesschangevideostatus(data)
        {
        ...
        function OnErrorchangevideostatus(content)
        { 
            ajaxrequest("POST","'<?php echo $config->getPage404url(); ?>'",'','',OnsuccessRender,OnErrorRender);
        }
		...
		//View Details Start
        function viewvideodata(id,videoid)
        {
            $('#videoframe').attr('src','https://www.youtube.com/embed/'+videoid+'?autoplay=1&rel=0&enablejsapi=1&playerapiid=ytplayer&wmode=transparent');
