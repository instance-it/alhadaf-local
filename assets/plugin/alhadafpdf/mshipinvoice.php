...
$qryord="select oi.id,oi.invoiceno,oi.invoicedate,o.orderno,convert(varchar,o.timestamp,103) as date_1,convert(varchar,o.timestamp,8) as time_1,pm.personname as membername,case when (isnull(pm.address,'')<>'') then pm.address else 'NA' end as member_address,o.totaltaxableamt,o.totaltax,o.totalpaid 
...
$pdf->SetTitle($roword['orderno']);
$pdf->SetSubject($roword['orderno']);
                        ...
                        $html .='<td style="padding-top:0px; padding-right: 0px; padding-bottom:0px; padding-left: 0px; text-align: center;vertical-align:middle;">';
                            $html .='<table cellpadding="0" cellspacing="0" valign="center" style="border-collapse: collapse;">';
                                ...
                                $html.='<tr>';
                                    ...
                                    $html.='</td>';
                                    $html.='<td align="right" width="60%" style="vertical-align:middle;">';
                                            $html.='<span style="color: #5785ae;font-size:12px;font-weight: bold;">'.$roword['orderno'].'</span>';
                                    $html.='</td>';
                                $html.='</tr>';
                            ...
                            $html .='<td style="padding-top:0px; padding-right: 0px; padding-bottom:0px; padding-left: 0px; text-align: center;vertical-align:middle;">';
                                ...
                                $html .='<table cellpadding="8" cellspacing="0" style="border-collapse: collapse;">';
                                    ...
                                    for($i=0;$i<sizeof($resod);$i++)
							        {
                                        ...
                                        $html.='<tr>
                                            <td align="left" style="vertical-align:middle;border-bottom: 1px solid #ddd;border-right: 1px solid #ddd;color:#5785ae;border-left: 1px solid #ddd;color:#5785ae;">'.$rowod['itemname'].'<p style="font-size: 9px;color:#5785ae;">Validity : '.$rowod['strvalidityduration'].'</p></td>
                                            <td align="right" style="vertical-align:middle;border-bottom: 1px solid #ddd;border-right: 1px solid #ddd;color:#5785ae;">'.round($rowod['taxable'],2).'</td>
                                            <td align="center" style="vertical-align:middle;border-bottom: 1px solid #ddd;border-right: 1px solid #ddd;color:#5785ae;">1</td>
...
else 
{
    ...
    $DB->executedata('u','tblorderinvoice',$orderinvdata,$orderinvupd);
