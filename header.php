            ...
            <nav class="js-mega-menu navbar navbar-expand-lg header-nav">
                ...
                <div id="navBar" class="collapse navbar-collapse">
                    <div class="navbar-contact text-md-right">
                        <ul class="navbar-country notranslate">
                            <li class="dropdown">
                                <a href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn btn-brand-04 main-link-toggle asrlanguage" data-name="English" data-language="en"><span class="flag-img d-none"><img src="<?php echo $config->getImageurl() ?>images/flag/qatar.png" alt="logo" class="img-fluid" width="25px" /></span> <text>English</text></a>
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <li>
                                        <a class="dropdown-item dropdown-item-en" href="javascript:void(0);" data-name="English" data-language="en"><span class="flag-img d-none"><img src="<?php echo $config->getImageurl() ?>images/flag/qatar.png" alt="logo" class="img-fluid" width="25px" /></span> <text>English</text></a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item dropdown-item-ar" href="javascript:void(0);" data-name="Arabic" data-language="ar"><span class="flag-img d-none"><img src="<?php echo $config->getImageurl() ?>images/flag/qatar.png" alt="logo" class="img-fluid" width="25px" /></span> <text>Arabic</text></a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                        <!-- <select id="h_languageid">
                        ...
                        <ul class="navbar-social">
                            ...
                            {
                            ?>
                                <li><a href="https://api.whatsapp.com/send?phone=<?php echo $ProjectSetting->getWhatsAppNo() ?>" target="_blank"><i class="fab fa-whatsapp"></i></a></li>
                            <?php
                            }
                            ?>
                    ...
                    <ul class="navbar-nav ml-auto main-navbar-nav notranslate">
                        <li class="nav-item custom-nav-item lihome">
                            <a class="nav-link custom-nav-link clsparentmenu lan-home-menu" pagename="home" href="javascript:void(0);">Home</a>
                        </li>
                        <li class="nav-item custom-nav-item licourses">
                            <a class="nav-link custom-nav-link clsparentmenu lan-course-menu" pagename="courses" href="javascript:void(0);">Courses</a>
                        </li>
                        <li class="nav-item custom-nav-item limembership">
                            <a class="nav-link custom-nav-link clsparentmenu lan-premembership-menu" pagename="membership" href="javascript:void(0);">Premium Membership</a>
                        </li>                            
                        <li class="nav-item custom-nav-item lispecialpackages">
                            <a class="nav-link custom-nav-link clsparentmenu lan-specialpackage-menu" pagename="specialpackages" href="javascript:void(0);">Special Packages</a>
                        </li>
                        <?php
                        if($LoginInfo->getUid()!='' && $LoginInfo->getIsguestuser()==0 && $LoginInfo->getUtypeid() != $config->getAdminutype())
                        {
                        ...
                        <li class="nav-item custom-nav-item lirangebooking">
                            <a class="nav-link custom-nav-link clsparentmenu lan-rangebook-menu" pagename="rangebooking" href="javascript:void(0);">Range Booking</a>
                        </li>
                        <?php
                        }
                        ?>
                        <li class="nav-item custom-nav-item liaboutus">
                            <a class="nav-link custom-nav-link clsparentmenu lan-aboutus-menu" pagename="aboutus" href="javascript:void(0);">About Us</a>
                        </li>
                        <li class="nav-item custom-nav-item ligallery">
                            <a class="nav-link custom-nav-link clsparentmenu lan-gallery-menu" pagename="gallery" href="javascript:void(0);">Gallery</a>
                        </li>
                        <li class="nav-item custom-nav-item licontactus">
                            <a class="nav-link custom-nav-link clsparentmenu lan-contactus-menu" pagename="contactus" href="javascript:void(0);">Contact Us</a>
                        </li> 
                        <?php
                        if($LoginInfo->getUid()!='' && $LoginInfo->getIsguestuser()==0 && $LoginInfo->getUtypeid() != $config->getAdminutype())
                        {
    ...
    <div class="mobile-footer-content">        
        <div class="mobile-country mb-2">
            <ul class="navbar-country notranslate">
                <li class="dropdown px-3">
                    <a href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn main-link-toggle w-100 asrlanguage11" data-name="English" data-language="en"><span class="flag-img"><img src="<?php echo $config->getImageurl() ?>images/flag/qatar.png" alt="logo" class="img-fluid" width="25px" /></span> <text>English</text></a>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <li>
                            <a class="dropdown-item" href="javascript:void(0);" data-name="English" data-language="en"><span class="flag-img d-none"><img src="<?php echo $config->getImageurl() ?>images/flag/qatar.png" alt="logo" class="img-fluid" width="25px" /></span> <text>English</text></a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="javascript:void(0);" data-name="Arabic" data-language="ar"><span class="flag-img d-none"><img src="<?php echo $config->getImageurl() ?>images/flag/qatar.png" alt="logo" class="img-fluid" width="25px" /></span> <text>Arabic</text></a>
                        </li>
                        <!-- <li>
        ...
        <div class="mobile-navigation">
            <ul>
                ...
                {
                ?>
                    <li class="limyaccount"><a class="clsparentmenu" pagename="myaccount" href="javascript:void(0);">My Account</a></li>
                <?php
                }
                else
                {
                ?>
                    <li><a class="" href="javascript:void(0);" data-toggle="modal" data-target="#registerModal">Become A Member</a></li>
                    <li><a class="" href="javascript:void(0);" data-toggle="modal" data-target="#loginModal">Login</a></li>
                <?php
                }   
                ?>
