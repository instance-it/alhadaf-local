    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-lg-12">
                <div class="row">
                    <div class="col-12" id="privacypolicyDiv">
...
<script>
    ...
    function fillcontentsetting()
    {
        ...
        formdata.append("contenttypeid", '<?php echo $config->getPrivacyPolicyId(); ?>');
    ...
    function Onsuccessfillcontentsetting(content)
    {
        ...
        {
            $('#privacypolicyDiv').html('<h3>'+resultdata.message+'</h3>');
        }
        else if(resultdata.status==1)
        {
            $('#privacypolicyDiv').html(resultdata.description);
        }
        else if(resultdata.status=-1)
        {
            logoutwebsitepage();
